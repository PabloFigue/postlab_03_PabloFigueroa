...
FINAL_IMAGE=${DISTDIR}/Hola_Mundo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=POSTLAB_03.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/POSTLAB_03.o
POSSIBLE_DEPFILES=${OBJECTDIR}/POSTLAB_03.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/POSTLAB_03.o

# Source Files
SOURCEFILES=POSTLAB_03.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Hola_Mundo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F887
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Hola_Mundo.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/POSTLAB_03.o: POSTLAB_03.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/POSTLAB_03.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/POSTLAB_03.o \
	POSTLAB_03.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Hola_Mundo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Hola_Mundo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
